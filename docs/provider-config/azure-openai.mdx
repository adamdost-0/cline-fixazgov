---
title: "Azure OpenAI"
description: "Learn how to configure Cline with Azure OpenAI and Azure AI Foundry model endpoints."
---

Cline supports Azure OpenAI Service as a dedicated provider with native support for both **Azure OpenAI** endpoints and **Azure AI Foundry** model endpoints. This provider offers enterprise-grade features including:
...
The Azure OpenAI provider in Cline offers a seamless, enterprise-ready experience for working with Azure-hosted AI models. Whether you're using traditional Azure OpenAI deployments or exploring the multi-provider capabilities of Azure AI Foundry, Cline provides the flexibility and security features you need for professional development.
